...
code_03A124:
  ...
  ; $03A142
  ; Question marks when Robot Masters Revisited
  ; 65: enable   00: disable
  db $65, $00, $65 ; Spark  Snake  Needle
  db $00, $00, $00 ; Hard   Mega   Top
  db $65, $00, $65 ; Gemini Magnet Shadow
  ...
  ; $03A1B1
  db $28, $26, $25, $24, $00, $2A, $27, $23, $29 

  ; Question marks sprite tile id
  db $1E, $00, $1E 
  db $00, $00, $00 
  db $1E, $00, $1E
  ...
  ; Question Mark Palettes
  db $0F, $0F, $2C, $11, $0F, $0F, $30, $37 ; $03A1D9 |

table tbl/MM3_Text_A.tbl,ltr

  db "NEEDLE MAN" ; $03A1E1 | Robot Masters Intro Text
  db "MAGNET MAN"
  db "GEMINI MAN"
  db "HARD   MAN"
  db "TOP    MAN"
...
cleartable
  ...
  db $7E, $E4, $00, $91  ; $03A2F9 |

table tbl/MM3_Text_A.tbl,ltr
  ; Text for Stage Select and intro splash screen.
  ; Text Chunks format:
  ; YY XX SS DD DD DD DD .. $FF

  ; Y: Tile Y index 
  ; X: Tile X index
  ; S: Size of chunk in bytes
  ; D: Text data byte 
  ; Chunk is ended with an $FF byte

txt_misc_A:
  db $22, $EA, $0F, "STAGE  SELECT   "
  db $23, $2A, $0A, "PASS   WORD"
  db $21, $D7, $02, $34, $17, $0D, $FF

txt_misc_B:
  db $23, $0A, $0A, "GAME   OVER" 
  db $21, $D7, $02, $34, $17, $0D, $FF 
  
txt_misc_C:
  db $22, $EA, $0C, "STAGE  SELECT"
  db $23, $0A, $0A, "           "
  db $23, $2A, $07, "CONTINUE"
  db $21, $D7, $02, $34, $17, $0D, $FF

txt_misc_D:
  db $20, $4A, $0B, "PUSH   START"
  db $21, $23, $05, "SPARK "
  db $21, $2D, $05, "SNAKE "
  db $21, $37, $05, "NEEDLE" 
  db $21, $43, $05, "   MAN"
...
txt_misc_F:
  db $21, $88, $06, "YOU GOT", $FF

txt_misc_G:
  db $21, $E5, $0C, "NEEDLE CANNON"
  db $22, $4A, $02, "AND"
  db $22, $88, $08, "RUSH  JET", $FF

txt_misc_H:
  db $21, $E5, $0D, "MAGNET MISSILE"
  db $FF

txt_misc_I:
  db $21, $E5, $0B, "GEMINI LASER", $FF

txt_misc_J:
  db $21, $E7, $0B, "HARD KNUCKLE", $FF

txt_misc_K:
  db $21, $E7, $07, "TOP SPIN", $FF

txt_misc_L:
  db $21, $E7, $0B, "SEARCH SNAKE", $FF

txt_misc_M:
  db $21, $E6, $0A, "SPARK SHOCK", $FF

txt_misc_N:
  db $21, $E5, $0B, "SHADOW BLADE"
  db $22, $4A, $02, "AND"
  db $22, $88, $0A, "RUSH MARINE", $FF
...
txt_misc_P:
  db $22, $EA, $0F, "PASS WORD ERROR!"
  db $23, $2A, $0A, "           ", $FF

txt_misc_Q:
  ; Text byte $3C is Copyright Symbol
  ; xkas doesn't support © symbol 
  db $21, $67, $12, $3C, "1990 CAPCOM CO.LTD"
  db $21, $A1, $1E, "TM AND ", $3C, "1990 CAPCOM U.S.A.,INC.", $FF

txt_misc_R:
  db $21, $EB, $0A, "LICENSED BY"
  db $22, $24, $18, "NINTENDO OF AMERICA. INC.", $FF
...
code_03A5A5:
  LDA $A6FF,y                               ; $03A5A5 |\
  STA $0204,y                               ; $03A5A8 | | Upload OAM Data
  LDA $A700,y                               ; $03A5AB | | for
  STA $0205,y                               ; $03A5AE | |
  LDA $A701,y                               ; $03A5B1 | |
  STA $0206,y                               ; $03A5B4 | |
  LDA $A702,y                               ; $03A5B7 | |
